...
const rename = (f, n) => (o, opts) => each(f(o, opts), desc => desc.p = desc.n = g(n)(desc.p, o));

// Apply a default, either directly, or by calling the provided function,
// which is the case when the default is specified with `==`.
const deflt  = (f, d, isFunc) => (o, opts) =>
        each(f(o, opts), desc => {
          if (desc.v === undefined) desc.v = isFunc ? d(desc.p, o) : d;
        });
